...
%ScannerLocation%\SonarQube.Scanner.MSBuild.exe begin /k:"SOLID" /d:sonar.organization="k7o-github" /d:sonar.host.url="https://sonarcloud.io" /d:sonar.login="e23d98e90e5f0bcea19b5278753638d6cdb83eab" /d:sonar.cs.vstest.reportsPaths="%CD%\TestResults\*.trx" /d:sonar.cs.vscoveragexml.reportsPaths="%CD%\TestResults\*.coveragexml"
...
%ScannerLocation%\SonarQube.Scanner.MSBuild.exe end /d:sonar.login="e23d98e90e5f0bcea19b5278753638d6cdb83eab"
